package practice.java.collections.maps.adeventuregame;
...
public class AdventureGame {
	...
	private static final String GAME_LOCATIONS="""
			road,at the end of the road, W: hill, E:well house, S:valley, N:forest hill, 
			on top of hill with a view in all directions, N:forest, E:road 
			well house, inside a well house for a small spring, W:road, N:lake, S:stream
			valley, in a forest vally beside a tumbling stream, N:road, W:hill,E:stream,
			forest, at the edge of thick  dark forest, S:road, E:lake 
			lake, by a alpine lake surrounded by wildfires, W:forest,S:well house 
