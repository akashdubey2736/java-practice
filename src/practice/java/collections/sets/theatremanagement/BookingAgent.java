package practice.java.collections.sets.theatremanagement;

import java.util.Set;

import practice.java.collections.sets.theatremanagement.Theatre.Seat;
...
public class BookingAgent {
	...
	public static void main(String[] args) {
		...
		Theatre bellCenter=new Theatre("Bell Center", rows, totalSeats);
		bellCenter.printSeatMap();
		
		bookSeat(bellCenter,'A',3);
		bookSeat(bellCenter,'A',3);
		bookSeat(bellCenter,'B',1);
		bookSeat(bellCenter,'B',11);
		bookSeat(bellCenter,'M',1);
		
		bookSeats(bellCenter,4,'B',3,10);
