...
public class Main {
	...
	public static void main(String[] args) {
		...
		Set<Task>marksTasks=TaskData.getTasks("mark");
		sortAndPrint("Mark's Tasks",marksTasks,sortByPriority);
		Set<Task>davidsTasks=TaskData.getTasks("david");
		sortAndPrint("David's Tasks",davidsTasks,sortByPriority);
		
		
		List<Set<Task>> sets=List.of(annsTasks,marksTasks,davidsTasks);
		...
		Set<Task> overlap=getUnion(List.of(getIntersect(annsTasks,marksTasks),
				getIntersect(marksTasks,davidsTasks),
				getIntersect(annsTasks,davidsTasks)));
		sortAndPrint("Overlapping tasks : ",overlap,sortByPriority);
