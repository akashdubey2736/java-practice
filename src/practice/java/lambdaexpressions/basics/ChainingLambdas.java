...
public class ChainingLambdas {
	...
	public static void main(String[] args) {
		...
		Function<String, String> lastName= s -> s.concat(" Martin");
		...
		Predicate<String> p1=s->s.equals("David");
		Predicate<String> p2=s->s.equalsIgnoreCase("David");
